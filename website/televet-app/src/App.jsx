    ...
    <div className="min-h-screen bg-[#F5F1E8]">
      ...
      <main className="max-w-7xl mx-auto px-6 py-12">
          ...
          <div className="row with-paws">
            <div className="column">
              ...
              <p className="step-description">
                Fill in the details of your furry friend.
              </p>
            </div>
            ...
            <div className="column">
              ...
              <p className="step-description">
                Search for available veterinarians or locate the nearest clinic
                to you.
              </p>
            </div>
            ...
            <div className="column">
              ...
              <p className="step-description">
                Book appointments or message your vet directly with any
                questions.
              </p>
            </div>
          </div>
        ...
        <section className="start-now-section">
          ...
          <div className="text-center max-w-3xl mx-auto">
            <h1 className="start-title">Frequently Asked Questions</h1>
          </div>
