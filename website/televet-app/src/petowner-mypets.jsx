...
const PetOwnerMyPets = () => {
  ...
  const handleUpdatePet = async () => {
    ...
    const emptyFields = requiredFields.filter(
      (field) =>
        !selectedPet[field] || selectedPet[field].toString().trim() === ""
    );
  ...
  const handleSubmitSoapNote = async () => {
    if (!newSoapNote.date || !newSoapNote.subjective) {
      setMessage({
        type: "error",
        text: "Please fill in at least the date and subjective fields",
      });
      return;
    }
    ...
    try {
      ...
      setMessage({
        type: "error",
        text: "Failed to save SOAP note. Please try again.",
      });
    }
  };
  ...
  const handleExportConfirm = async () => {
    ...
    try {
      ...
      pdf.text(`${selectedPet.name}'s Medical Records`, pageWidth / 2, 18, {
        align: "center",
      });
      ...
      pdf.text("TeleVet Pet Management System", pageWidth / 2, 34, {
        align: "center",
      });
      ...
      if (exportOptions.healthRecords) {
        ...
        if (examinations.length > 0) {
          ...
          examinations.forEach((exam, index) => {
            ...
            pdf.setTextColor(15, 23, 42);
            pdf.text(
              `${exam.appt_type} - ${exam.consultation_type}`,
              margin,
              yPos
            );
        ...
        if (soapNotes.length > 0) {
          ...
          soapNotes.forEach((note, index) => {
            ...
            if (note.subj) {
              ...
              yPos += 4;
              pdf.setFont(undefined, "normal");
              yPos = addText(note.subj, margin + 3, yPos, {
                fontSize: 9,
                maxWidth: contentWidth - 6,
              });
              yPos += 3;
            ...
            if (note.obj) {
              ...
              yPos += 4;
              pdf.setFont(undefined, "normal");
              yPos = addText(note.obj, margin + 3, yPos, {
                fontSize: 9,
                maxWidth: contentWidth - 6,
              });
              yPos += 3;
            ...
            if (note.assess) {
              ...
              yPos += 4;
              pdf.setFont(undefined, "normal");
              yPos = addText(note.assess, margin + 3, yPos, {
                fontSize: 9,
                maxWidth: contentWidth - 6,
              });
              yPos += 3;
            ...
            if (note.plan) {
              ...
              yPos += 4;
              pdf.setFont(undefined, "normal");
              yPos = addText(note.plan, margin + 3, yPos, {
                fontSize: 9,
                maxWidth: contentWidth - 6,
              });
              yPos += 3;
      ...
      if (exportOptions.trackingMonitoring) {
        ...
        if (trackingData.symptomLog.length > 0) {
          ...
          trackingData.symptomLog.forEach((s, index) => {
            ...
            pdf.setTextColor(100, 116, 139);
            pdf.text(
              new Date(s.symp_date).toLocaleDateString("en-GB"),
              pageWidth - margin,
              yPos,
              { align: "right" }
            );
            ...
            pdf.setFontSize(9);
            pdf.setTextColor(71, 85, 105);
            yPos = addText(s.symp_desc, margin + 3, yPos, {
              fontSize: 9,
              maxWidth: contentWidth - 6,
            });
        ...
        if (trackingData.behaviorLog.length > 0) {
          ...
          trackingData.behaviorLog.forEach((b, index) => {
            ...
            pdf.setTextColor(100, 116, 139);
            pdf.text(
              new Date(b.behav_date).toLocaleDateString("en-GB"),
              pageWidth - margin,
              yPos,
              { align: "right" }
            );
            ...
            pdf.setFontSize(9);
            pdf.setTextColor(71, 85, 105);
            yPos = addText(b.behav_note, margin + 3, yPos, {
              fontSize: 9,
              maxWidth: contentWidth - 6,
            });
      ...
      pdf.setFont(undefined, "normal");
      pdf.text(
        "This document was generated from TeleVet Pet Management System",
        pageWidth / 2,
        yPos,
        { align: "center" }
      );
      yPos += 5;
      pdf.text(
        "For veterinary use and pet owner records",
        pageWidth / 2,
        yPos,
        { align: "center" }
      );
      ...
      // Save the PDF
      pdf.save(
        `${selectedPet.name}_Medical_Records_${
          ...
          <div className="pet-details-section add-pet-form">
            ...
            <div className="details-container">
              <div className="section-box section-wide">
                <form
                  onSubmit={
                    addPetStep === 2 ? handleSubmitNewPet : handleAddPetNext
                  }
                >
                  {/* Step 1: Pet Basics */}
                  {addPetStep === 1 && (
                  ...
                  {addPetStep === 2 && (
                    <div className="form-content">
                        ...
                        <div className="radio-group">
                          <label>
                            <input
                              ...
                              name="hasVaccination"
                              value="yes"
                              checked={newPetData.hasVaccination === "yes"}
                              onChange={handleNewPetChange}
                              required
                            />
                            Yes
                          ...
                          <label>
                            <input
                              ...
                              name="hasVaccination"
                              value="no"
                              checked={newPetData.hasVaccination === "no"}
                              onChange={handleNewPetChange}
                            />
                            No
                          </label>
                      ...
                      {newPetData.hasVaccination === "yes" && (
                        <div className="form-group">
                          ...
                          <input
                            ...
                            value={newPetData.vaccinationDate}
                            onChange={handleNewPetChange}
                            required
                          />
                        </div>
                        ...
                        <div className="radio-group">
                          <label>
                            <input
                              ...
                              name="hasMedication"
                              value="yes"
                              checked={newPetData.hasMedication === "yes"}
                              onChange={handleNewPetChange}
                              required
                            />
                            Yes
                          ...
                          <label>
                            <input
                              ...
                              name="hasMedication"
                              value="no"
                              checked={newPetData.hasMedication === "no"}
                              onChange={handleNewPetChange}
                            />
                            No
                          </label>
                      ...
                      {newPetData.hasMedication === "yes" && (
                        <div className="form-group">
                          ...
                          <textarea
                            ...
                            value={newPetData.medicationDetails}
                            onChange={handleNewPetChange}
                            required
                          />
                        </div>
                        ...
                        <div className="radio-group">
                          <label>
                            <input
                              ...
                              name="hasAllergies"
                              value="yes"
                              checked={newPetData.hasAllergies === "yes"}
                              onChange={handleNewPetChange}
                              required
                            />
                            Yes
                          ...
                          <label>
                            <input
                              ...
                              name="hasAllergies"
                              value="no"
                              checked={newPetData.hasAllergies === "no"}
                              onChange={handleNewPetChange}
                            />
                            No
                          </label>
                      ...
                      <div className="form-group">
                        ...
                        <textarea
                          name="dietType"
                          value={newPetData.dietType}
                          onChange={handleNewPetChange}
                          placeholder="E.g., commercial food types (dry, wet, semi-moist), home-cooked, and raw meat-based"
                          required
                        />
                      </div>
                      ...
                      <div className="form-group">
                        <textarea
                          ...
                          value={newPetData.behavioralNotes}
                          onChange={handleNewPetChange}
                          placeholder="E.g., aggression, anxiety, chewing"
                        />
                      </div>
                  ...
                  <div className="section-content">
                    {!activeHealthView ? (
                      ...
                      <div className="dashboard-grid">
                        ...
                        <div
                          className="dashboard-card"
                          onClick={() => setActiveHealthView("prescriptions")}
                        >
                          <Pill size={32} />
                          <h4>Prescriptions</h4>
                        ...
                        <div
                          className="dashboard-card"
                          onClick={() => setActiveHealthView("soap")}
                        >
                          <FileText size={32} />
                          <h4>SOAP Notes</h4>
                      ...
                      <div className="detailed-view">
                        ...
                        {activeHealthView === "soap" && (
                          <>
                            <h3>My SOAP Notes</h3>
                            <p className="soap-description">
                              Keep track of your pet's daily observations and
                              health notes.
                            </p>
                            ...
                            <div className="saved-soap-notes">
                              ...
                              {soapNotes.length === 0 ? (
                                <p className="no-data">
                                  No personal notes yet. Start adding
                                  observations above!
                                </p>
                              ) : (
                                soapNotes.map((note) => (
                                  <div key={note.soap_id} className="soap-item">
                                    ...
                                    {note.subj && (
                                      <p>
                                        <strong>Subjective:</strong> {note.subj}
                                      </p>
                                    )}
                                    {note.obj && (
                                      <p>
                                        <strong>Objective:</strong> {note.obj}
                                      </p>
                                    )}
                                    {note.assess && (
                                      <p>
                        ...
                        <div className="dashboard-card large-card">
                          ...
                          <div className="card-actions">
                            ...
                            <button
                              className="btn-add-section"
                              onClick={() =>
                                handleOpenTrackingModal("activity")
                              }
                            >
                        ...
                        <div className="dashboard-card large-card">
                          ...
                          <div className="card-actions">
                            ...
                            <button
                              className="btn-add-section"
                              onClick={() =>
                                handleOpenTrackingModal("symptoms")
                              }
                            >
                              <Plus size={16} /> Add Entry
                            </button>
                        ...
                        <div className="dashboard-card large-card">
                          ...
                          <div className="behavior-list">
                            ...
                            {trackingData.behaviorLog.length === 0 && (
                              <p className="no-data">No behavioral notes yet</p>
                            )}
                          </div>
                          <div className="card-actions">
                            <button
                            ...
                            <button
                              className="btn-add-section"
                              onClick={() =>
                                handleOpenTrackingModal("behavior")
                              }
                            >
                          ...
                          <>
                            <div className="tracking-header">
                              ...
                              <button
                                className="btn-add-section"
                                onClick={() =>
                                  handleOpenTrackingModal("weight")
                                }
                              >
                                <Plus size={16} /> Add Entry
                              </button>
                        ...
                        {activeTrackingView === "activity" && (
                          <>
                            ...
                            <div className="activity-list">
                              ...
                              {trackingData.activityLog.length === 0 && (
                                <p className="no-data">
                                  No activities logged yet. Click "Add Activity"
                                  to start tracking.
                                </p>
                              )}
                            </div>
                        ...
                        {activeTrackingView === "behavior" && (
                          <>
                            ...
                            <div className="behavior-list">
                              ...
                              {trackingData.behaviorLog.length === 0 && (
                                <p className="no-data">
                                  No behavioral notes yet. Click "Add Note" to
                                  start tracking.
                                </p>
                              )}
                            </div>
                  ...
                  <div className="pet-info-details">
                    ...
                    <div className="info-row">
                      ...
                      {isEditing ? (
                        ...
                        <span>
                          {selectedPet.gender === "m"
                            ? "Male"
                            : selectedPet.gender === "f"
                            ? "Female"
                            : selectedPet.gender}
                        </span>
                      )}
                    ...
                    <div className="info-row">
                      ...
                      {isEditing ? (
                        ...
                        <span>
                          {selectedPet.hasVaccination === "yes" ? "Yes" : "No"}
                        </span>
                      )}
                    </div>
                          ...
                          <input
                            ...
                            value={
                              selectedPet.vaccinationDate
                                ? new Date(selectedPet.vaccinationDate)
                                    .toISOString()
                                    .split("T")[0]
                                : ""
                            }
                    ...
                    <div className="info-row">
                      ...
                      {isEditing ? (
                        ...
                        <span>
                          {selectedPet.hasMedication === "yes" ? "Yes" : "No"}
                        </span>
                      )}
                    </div>
                    ...
                    <div className="info-row">
                      ...
                      {isEditing ? (
                        ...
                        <span>
                          {selectedPet.hasAllergies === "yes" ? "Yes" : "No"}
                        </span>
                      )}
                    </div>
          ...
          <div className="modal-container" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-body">
              <p className="export-description">
                Select the data you want to export for {selectedPet?.name}
              </p>
              ...
              <div className="export-options">
                <label className="export-option">
                  ...
                  <span className="export-option-label">
                    ...
                    <span className="export-option-description">
                      Basic info (name, species, breed, age, weight, diet,
                ...
                <label className="export-option">
                  ...
                  <span className="export-option-label">
                    ...
                    <span className="export-option-description">
                      Examinations, treatments, prescriptions, SOAP notes,
                      vaccinations, conditions, surgeries
                    </span>
                  </span>
                </label>
                ...
                <label className="export-option">
                  <input
                    ...
                    onChange={() =>
                      handleExportOptionChange("trackingMonitoring")
                    }
                  />
                  <span className="export-option-label">
              ...
              <div className="modal-actions">
                ...
                <button
                  ...
                  disabled={
                    !exportOptions.petInfo &&
                    !exportOptions.healthRecords &&
                    !exportOptions.trackingMonitoring
                  }
                >
                  Export as Document
                </button>
