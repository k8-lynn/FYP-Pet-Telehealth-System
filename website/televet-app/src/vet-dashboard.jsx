...
const VetDashboard = () => {
  ...
  const fetchDashboardData = async () => {
    ...
    try {
      ...
      const upcomingCount = appointments.filter((appt) => {
        ...
        return (
          apptDate >= today &&
          (appt.appt_status === "scheduled" || appt.appt_status === "pending")
        );
      }).length;
  ...
  const handleRescheduleRequest = async (apptId, rescheduleReason) => {
    const requestedBy = "veterinarian";
                    ...
                    <div key={appointment.appt_id} className="table-row">
                      <div className="table-cell">
                        <span className="appointment-time">
                          {formatAppointmentTime(appointment.appt_date)}
                        </span>
                      </div>
                      <div className="table-cell">
                        <span className="pet-name-table">
                          {appointment.pet_name}
                        </span>
                      </div>
                      <div className="table-cell">
                        <span className="owner-name">
                          {appointment.owner_firstName}{" "}
                          {appointment.owner_lastName}
                        </span>
                      </div>
                      <div className="table-cell">
                        <span
                      ...
                      <div className="table-cell">
                        <button
                          ...
                          onClick={() =>
                            fetchAppointmentDetails(appointment.appt_id, true)
                          }
